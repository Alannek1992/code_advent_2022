...
use puzzles::{
    ...
    seventh_puzzle::SeventhPuzzle, sixth_puzzle::SixthPuzzle, third_puzzle::ThirdPuzzle, tenth_puzzle::TenthPuzzle, eleventh_puzzle::EleventhPuzzle, twelfth_puzzle::TwelfthPuzzle,
};
